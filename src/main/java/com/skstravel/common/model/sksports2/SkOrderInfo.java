...
public class SkOrderInfo implements Serializable {
    ...
    private Integer isPcMobile;

    private String qcData;

    private String spm;

    private Integer credisNum;
    ...
    public Integer getCouponPaid() {
        return couponPaid;
    }

    public void setCouponPaid(Integer couponPaid) {
    ...
    public Integer getIsPcMobile() {
        return isPcMobile;
    }

    public void setIsPcMobile(Integer isPcMobile) {
        this.isPcMobile = isPcMobile;
    }
    ...
    public Integer getCredisNum() {
        return credisNum;
    }

    public void setCredisNum(Integer credisNum) {
        this.credisNum = credisNum;
    }

    public Boolean getThirdPlatform() {
        return thirdPlatform;
    }

    public void setThirdPlatform(Boolean thirdPlatform) {
